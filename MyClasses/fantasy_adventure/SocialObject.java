...
class SocialObject extends LivingObject{
  ...
  */
  ...
  /* Biography keeps track of a few random but major stats,
...
//*************************************************************************
  ...
  void writeToFile(BufferedWriter bw) throws IOException{
    ...
    disposition.writeToFile(bw);

    // write the biography
    biography.writeToFile(bw);
...
//    Popup.createInfoPopup("reading Social Object from String:" + MyTextIO.newline + thisLine);
    ...
    // get disposition
    disposition.readFromFile(br);

    // get Biography
    biography.readFromFile(br);
