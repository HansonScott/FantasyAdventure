...
// internal objects within geneticsPanel
  ...
  String     raceDescription        = FileNames.CGEN_RACE_DESC;
  String     nameDescriptionMessage = FileNames.CGEN_NAME_DESC;
  String     ageDescription         = FileNames.CGEN_AGE_DESC;
  JLabel     raceLabel;
  JComboBox  raceList;
  String     raceChoice;
  JLabel     ageLabel;
...
public GeneticsScreen(){
  ...
  raceLabel.addMouseListener(this);

  raceList = new JComboBox(Race.getPlayableRaceNames());
...
//  Popup.createInfoPopup("Combo box created and set, raceChoice: " + raceChoice);
  ...
  genderLabel.addMouseListener(this);
  ...
  ageLabel.addMouseListener(this);
  ...
  fullNameLabel.addMouseListener(this);
  ...
  shortNameLabel.addMouseListener(this);
...
// ************************************************************
  public void mouseClicked(MouseEvent e){
    if (e.getSource() == raceLabel){
      descriptionArea.setText(raceDescription);
    } // end if raceLabel

    else if (e.getSource() == genderLabel){
      descriptionArea.setText(genderDescription);
    } // end if genderLabel

    else if (e.getSource() == ageLabel){
      descriptionArea.setText(ageDescription);
    } // end if ageLabel

    else if (e.getSource() == fullNameLabel ||
             e.getSource() == shortNameLabel){
